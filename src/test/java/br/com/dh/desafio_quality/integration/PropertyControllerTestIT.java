...
public class PropertyControllerTestIT {
    ...
    void setup() {
        ...
        repository.save(new Property(propertyRequest.getPropName(), propertyRequest.getPropDistrict(), propertyRequest.getRooms()));
    }
    ...
    void newProperty_ReturnProperty_Success() throws Exception {
        ...
        ResultActions response = mockMvc.perform(post("/property")
    ...
    void getProperty_returnProperty_Success() throws Exception {
        ...
        ResultActions response = mockMvc.perform(get("/property/{id}", property.getId() )
                .contentType(MediaType.APPLICATION_JSON));
    ...
    void getProperty_returnProperty_NotFound() throws Exception {
        ...
        ResultActions response = mockMvc.perform(get("/property/{id}", "3275b207-4711-4801-9e29-1bd09ae71faf" )
                .contentType(MediaType.APPLICATION_JSON));

        response.andExpect(status().isOk())
                .andExpect(jsonPath("$.id", CoreMatchers.is("3275b207-4711-4801-9e29-1bd09ae71faf")))
                .andExpect(jsonPath("$.propName", CoreMatchers.is(property.getPropName())))
                .andExpect(jsonPath("$.propArea", CoreMatchers.is(120.0)))
                .andExpect(jsonPath("$.propValue", CoreMatchers.is(120000.0)));
