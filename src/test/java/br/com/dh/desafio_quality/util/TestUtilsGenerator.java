...
//import br.com.dh.desafio_quality.dto.RoomRequestDTO;
//import br.com.dh.desafio_quality.dto.RoomResponseDTO;
...
//        District district = new District("Santa Teresa", new BigDecimal("3000.0"));
//        RoomRequestDTO room1 = new RoomRequestDTO(new Room("Living room", 15, 10));
//        RoomRequestDTO room2 = new RoomRequestDTO(new Room("Bedroom", 30, 10));
//        RoomRequestDTO room3 = new RoomRequestDTO(new Room("Office", 9, 3));
//
